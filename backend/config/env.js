...
module.exports = {
  ...
  businessName: String(process.env.BUSINESS_NAME || "Wadhwani Associates").trim(),
  businessPhone: String(process.env.BUSINESS_PHONE || "+91 96968 93625").trim(),
  businessEmail: String(process.env.BUSINESS_EMAIL || "support@bizsamadhanindia.com").trim(),
  ...
  businessPostalCode: String(process.env.BUSINESS_POSTAL_CODE || "208027").trim(),
  businessStreetAddress: String(process.env.BUSINESS_STREET_ADDRESS || "LIG 25 SF Colony, Barra 3").trim(),
  supportPerson: String(process.env.SUPPORT_PERSON || "Vikram Wadhwani").trim(),
  supportPhoneSecondary: String(process.env.SUPPORT_PHONE_SECONDARY || "+91 83033 40092").trim(),
